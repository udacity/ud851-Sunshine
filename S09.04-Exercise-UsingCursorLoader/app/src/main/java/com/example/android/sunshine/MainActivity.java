...
//  COMPLETED (16) Create a String array containing the names of the desired data columns from our ContentProvider
    private String[] names_of_data_columns = {
...
//          COMPLETED (22) If the loader requested is our forecast loader, return the appropriate CursorLoader
        Uri providerUri = WeatherContract.WeatherEntry.CONTENT_URI;
        switch (id){
            case ID_FORECAST_LOADER:
                CursorLoader cl = new CursorLoader(this);
                cl.setUri(providerUri);
                cl.setProjection(names_of_data_columns);
                return cl;
        }
        return null;
    }
...
//        mForecastAdapter.setWeatherData(data);
        ...
        if (data != null && data.getCount() != 0 ){
            ...
            mErrorMessageDisplay.setText(data.toString());
        }
    }
