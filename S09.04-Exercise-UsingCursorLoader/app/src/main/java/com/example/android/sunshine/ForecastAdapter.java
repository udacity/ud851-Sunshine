...
//      TODO (7) Generate a weather summary with the date, description, high and low
        long normalizedDate = mCursor.getLong(MainActivity.INDEX_WEATHER_DATE);
        String stringDate = SunshineDateUtils.getFriendlyDateString(mContext, normalizedDate, false);
        int weatherConditionId = mCursor.getInt(MainActivity.INDEX_WEATHER_CONDITION_ID);
        String weatherConditionString = SunshineWeatherUtils.getStringForWeatherCondition(mContext, weatherConditionId);
        ...
        String weatherSummary = stringDate + " - " + weatherConditionString + " - " + maxAndminTemperature;
