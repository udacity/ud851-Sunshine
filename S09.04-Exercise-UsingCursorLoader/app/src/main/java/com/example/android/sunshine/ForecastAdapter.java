...
//      TODO (7) Generate a weather summary with the date, description, high and low
        ...
        String dateString = SunshineDateUtils.getFriendlyDateString(mContext, dateInMilliseconds, false);
        int dateId = mCursor.getInt(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_WEATHER_ID));
        String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext, dateId);
