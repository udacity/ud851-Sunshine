...
//  TODO (1) Create a constant int value to identify the notification
    private static final int WEATHER_NOTIFICATION_ID = 39;
...
//          TODO (2) Use NotificationCompat.Builder to begin building the notification
            ...
            Intent intentForDetail = new Intent(context, DetailActivity.class);
            intentForDetail.setData(todaysWeatherUri);


            TaskStackBuilder taskStackBuilder = TaskStackBuilder.create(context);

            taskStackBuilder.addNextIntentWithParentStack(intentForDetail);
