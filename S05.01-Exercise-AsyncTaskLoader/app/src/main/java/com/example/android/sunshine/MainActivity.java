...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int WEATHER_ASYNC_LOADER_ID = 11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(WEATHER_ASYNC_LOADER_ID, null, this);
    }
    ...
    public Loader<String[]> onCreateLoader(int id, Bundle args) {
        return new AsyncTaskLoader<String[]>(this){
            ...
            public void deliverResult(String [] data){
                jsonWeatherData = data;
                super.deliverResult(jsonWeatherData);
            }
        };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            getSupportLoaderManager().restartLoader(WEATHER_ASYNC_LOADER_ID,null,this);
            return true;
        }
